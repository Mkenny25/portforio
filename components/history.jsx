    ...
    return (
        <>
            ...
            <div className={styles.containerLeft}>
                    <div className={styles.dateLeft}>2020/02~</div>
                ...
                <div className={styles.containerRight}>
                    <div className={styles.dateRight}>2020/10~</div>
                ...
                <div className={styles.containerLeft}>
                    <div className={styles.dateLeft}>2021/05~</div>
                    <i className={styles.iconLeft} >
                ...
                <div className={styles.containerRight}>
                    <div className={styles.dateRight}>2021/11~</div>
                    <i className={styles.iconRight} >
